      ...
      <tbody>
        ...
        <td class="align-center w120">
            <a href="index.php?act=store&op=store_joinin_detail&member_id=<?php echo $v['member_id'];?>">查看</a>&nbsp;&nbsp;<a href="index.php?act=store&op=store_edit&store_id=<?php echo $v['store_id']?>"><?php echo $lang['nc_edit'];?></a>&nbsp;&nbsp;
               ...
               <a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del']?>')){location.href='index.php?act=store&op=store_del&store_id=<?php echo $v['store_id']; ?>'}"><?php echo $lang['nc_del']?></a>&nbsp;&nbsp; <a href="index.php?act=store&op=store_bind_class&store_id=<?php echo $v['store_id']?>">经营类目</a>
                <?php } ?>
            </td>
        </tr>
        <?php } ?>
